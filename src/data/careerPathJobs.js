...
export const careerPathJobs = {
  ...
  verwaltung: {
    ...
    professionals: [
      {
        id: 'verwaltung-professionals-description',
        type: 'description',
        description: 'Übernimm Verantwortung für die individuelle Weiterentwicklung unserer Märkte, tausche dich mit Führungskräften vor Ort aus und entwickle dich selbst kontinuierlich weiter. Gleichzeitig kannst du in unserer Unternehmenszentrale oder in den Regionszentralen aktiv an strategischen Projekten mitwirken und so den Handel von morgen mitgestalten.',
        subtitle: 'Entdecke die vielfältigen Möglichkeiten, mit denen wir REWE gemeinsam voranbringen.',
        links: [
          {
            text: 'Jobs in der Zentrale',
            url: 'https://karriere.rewe.de/jobs/suche?term=&location=Eching%2C+Deutschland&range=5&sort=date&shifttypes%5B%5D=F%C3%BChrungsposition&shifttypes%5B%5D=Berufserfahrung&shifttypes%5B%5D=Berufseinstieg&shifttypes%5B%5D=Aushilfsjob&facilities%5B%5D=Controlling+%26+Finanzen&facilities%5B%5D=Einkauf&facilities%5B%5D=Human+Resources&facilities%5B%5D=Immobilien&facilities%5B%5D=Informationstechnologie&facilities%5B%5D=Marketing+%26+PR&facilities%5B%5D=Recht+%26+Revision&facilities%5B%5D=Strategie&facilities%5B%5D=Weitere+Funktionen&lat=48.2983793&lng=11.6212063&nobounds=0&index='
          },
          {
            text: 'Jobs im Außendienst',
            url: 'https://karriere.rewe.de/jobs/suche?term=&location=&range=25&sort=date&shifttypes%5B%5D=F%C3%BChrungsposition&shifttypes%5B%5D=Berufserfahrung&shifttypes%5B%5D=Berufseinstieg&shifttypes%5B%5D=Aushilfsjob&facilities%5B%5D=Gebietsmanagement&facilities%5B%5D=Vertriebsleitung&facilities%5B%5D=Weitere+Funktionen+Vertrieb&lat=&lng=&nobounds=0&index=1'
          }
        ],
        entryLevel: 'Professionals'
      }
