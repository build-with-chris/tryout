...
function Feature297Card({ item, isActive, isAnimated, onItemClick, renderContent }) {
  const title = item.title ?? (item.titlePrefix != null && item.titleTyping != null ? `${item.titlePrefix} ${item.titleTyping}` : "");
          ...
          <div className="flex justify-center">
            <div className={cn(
              ...
              {isActive ? (
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-transform duration-300">
                  <path d="M12 5V19M5 12H19" stroke="#CC071E" strokeWidth="3" strokeLinecap="round" />
                </svg>
              )}
            </div>
          </div>
