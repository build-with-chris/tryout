...
const Hero143 = ({
  ...
  return (
    <section
        ...
        <div className="flex flex-col items-center">
          <div className="flex flex-col items-center gap-8 px-4 pt-52 pb-32 md:pb-52">
            <div className="max-w-[25rem] sm:max-w-[33.75rem]">
              <h1
                className="text-center text-4xl leading-tight font-semibold text-foreground [text-shadow:0_4px_4px_rgba(0,0,0,0.15)] sm:text-5xl md:text-[4rem]">
                REWE deinen Traum
              </h1>
            </div>
            <div className="max-w-[22.5rem] md:max-w-full">
              <p
                className="text-center text-sm leading-normal tracking-tight text-balance text-muted-foreground [text-shadow:0_4px_4px_rgba(0,0,0,0.25)] md:text-lg">
                Chancen erkennt man nicht. Man ergreift sie. Bei REWE.
              </p>
            </div>
          </div>
          <div className="flex flex-col items-center gap-4">
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Button
                ...
                <a href="#" onClick={(e) => { e.preventDefault(); onAreaSelect && onAreaSelect('markt'); }}>
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
                    strokeWidth="0"
              ...
              <Button
                ...
                <a href="#" onClick={(e) => { e.preventDefault(); onAreaSelect && onAreaSelect('logistik'); }}>
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
                    strokeWidth="0"
                    ...
                    xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M0 93.7l183.6-25.3v177.4H0V93.7zm0 324.6l183.6 25.3V268.4H0v149.9zm203.8 28L448 480V268.4H203.8v177.9zm0-380.6v180.1H448V32L203.8 65.7z"></path>
                  </svg>
                  <p>Logistik</p>
                </a>
              </Button>
            ...
            <div className="flex gap-6 text-xs text-muted-foreground">
              ...
              <span className="relative before:absolute before:-left-3 before:content-['|']">
                <button onClick={() => onAreaSelect && onAreaSelect('markt')}>Markt</button>
              </span>
            </div>
          </div>
          <a
            ...
            <span>Erklimm unsere Karriereleiter werden</span>
      ...
      <div
        className="absolute -top-24 z-10 h-full w-full before:absolute before:inset-0 before:size-full before:bg-[radial-gradient(circle_at_center,rgba(10,10,10,.3)_15%,rgba(10,10,10,1)_45%)] before:content-['']">
        <video
