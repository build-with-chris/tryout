...
const Integration8 = ({
  ...
  const zeile1 = [
    ...
    "Mitarbeiter:in Warenverräumung",
    "Aushilfe / Minijob",
    "Marktmanager:in / Filialleiter:in",
    "Bereichsleiter:in /Abteilungsleiter:in Frischetheke",
    "Verkäufer:in Frischetheke Metzgerei",
    "Fleischer:in / Metzger:in Verkauf Frischetheke Metzgerei",
    "Bereichsleiter:in /Abteilungsleiter:in Frischetheke Metzgerei",
